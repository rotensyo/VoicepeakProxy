...
### 初期設定
1. [Release](https://github.com/rotensyo/VoicepeakProxy/releases/latest) で配布されている最新のプラグインをダウンロード・解凍してください。
...
### 使用方法
[Release](https://github.com/rotensyo/VoicepeakProxy/releases/latest) で配布されている最新のライブラリをダウンロード・解凍し、下記を参考に任意の環境で実装を行ってください。
